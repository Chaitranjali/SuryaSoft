...
import com.hello.suryasoftassign.uitility.SuryaSoftApplication;
...
public class ChurchTalkServiceFactory {

    public static String BASE_URL = "http://surya-interview.appspot.com/";

    private ChurchTalkServiceFactory() {
    }
    ...
    private final static Interceptor REWRITE_CACHE_CONTROL_INTERCEPTOR = new Interceptor() {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            int netWorkState = NetworkUtil.getNetworkState(SuryaSoftApplication.getInstance());
